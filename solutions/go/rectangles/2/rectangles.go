...
func Count(diagram []string) int {
	...
	corners := findCorners(diagram, rows, cols)
	count := 0
...
// findCorners finds all potential corners ('+' characters) in the diagram
func findCorners(diagram []string, rows, cols int) [][]int {
	corners := make([][]int, 0)
